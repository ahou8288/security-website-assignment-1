...
2017-09-13 17:58:46, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:00:53, SELECT 1 FROM sqlite_master WHERE type='table' AND name='USER';
2017-09-13 18:00:53, SELECT 1 FROM sqlite_master WHERE type='table' AND name='LOGIN_REQUESTS';
2017-09-13 18:00:53, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:00:53, SELECT 1 FROM sqlite_master WHERE type='table' AND name='USER';
2017-09-13 18:00:53, SELECT 1 FROM sqlite_master WHERE type='table' AND name='LOGIN_REQUESTS';
2017-09-13 18:00:53, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:00:59, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:00:59, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(12, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:00:59, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('username', 'user1')
2017-09-13 18:00:59, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('session_id', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3')
2017-09-13 18:00:59, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('ip', '127.0.0.1')
2017-09-13 18:00:59, SELECT id, salt
		FROM USER
		WHERE username=?	('user1',)
2017-09-13 18:00:59, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:01:02, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:01:02, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(13, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:01:02, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('username', 'user1')
2017-09-13 18:01:02, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('session_id', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3')
2017-09-13 18:01:02, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('ip', '127.0.0.1')
2017-09-13 18:01:02, SELECT id, salt
		FROM USER
		WHERE username=?	('user1',)
2017-09-13 18:01:02, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:01:06, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:01:06, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(14, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:01:06, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('username', 'user1')
2017-09-13 18:01:06, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('session_id', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3')
2017-09-13 18:01:06, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('ip', '127.0.0.1')
2017-09-13 18:01:06, SELECT id, salt
		FROM USER
		WHERE username=?	('user1',)
2017-09-13 18:01:06, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:01:07, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:01:07, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(15, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:01:07, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('username', 'user1')
2017-09-13 18:01:07, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('session_id', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3')
2017-09-13 18:01:07, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('ip', '127.0.0.1')
2017-09-13 18:01:07, SELECT id, salt
		FROM USER
		WHERE username=?	('user1',)
2017-09-13 18:01:07, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:01:09, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:01:09, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(16, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:01:09, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('username', 'user1')
2017-09-13 18:01:09, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('session_id', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3')
2017-09-13 18:01:09, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('ip', '127.0.0.1')
2017-09-13 18:01:09, SELECT id, salt
		FROM USER
		WHERE username=?	('user1',)
2017-09-13 18:01:09, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:01:10, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:01:10, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(17, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:01:10, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('username', 'user1')
2017-09-13 18:01:10, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('session_id', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3')
2017-09-13 18:01:10, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('ip', '127.0.0.1')
2017-09-13 18:01:10, SELECT id, salt
		FROM USER
		WHERE username=?	('user1',)
2017-09-13 18:01:10, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:01:12, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:01:12, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(18, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:01:12, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('username', 'user1')
2017-09-13 18:01:12, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('session_id', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3')
2017-09-13 18:01:12, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('ip', '127.0.0.1')
2017-09-13 18:01:12, SELECT id, salt
		FROM USER
		WHERE username=?	('user1',)
2017-09-13 18:01:12, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:01:14, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:01:14, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(19, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:01:14, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('username', 'user1')
2017-09-13 18:01:14, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('session_id', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3')
2017-09-13 18:01:14, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('ip', '127.0.0.1')
2017-09-13 18:01:14, SELECT id, salt
		FROM USER
		WHERE username=?	('user1',)
2017-09-13 18:01:14, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:01:16, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:01:16, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(20, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:01:16, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('username', 'user1')
2017-09-13 18:01:16, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('session_id', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3')
2017-09-13 18:01:16, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('ip', '127.0.0.1')
2017-09-13 18:01:16, SELECT id, salt
		FROM USER
		WHERE username=?	('user1',)
2017-09-13 18:01:16, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:01:17, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:01:17, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(21, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:01:17, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('username', 'user1')
2017-09-13 18:01:17, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('session_id', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3')
2017-09-13 18:01:17, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('ip', '127.0.0.1')
2017-09-13 18:01:17, SELECT id, salt
		FROM USER
		WHERE username=?	('user1',)
2017-09-13 18:01:17, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:01:18, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:01:18, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(22, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:01:18, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('username', 'user1')
2017-09-13 18:01:18, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('session_id', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3')
2017-09-13 18:01:18, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('ip', '127.0.0.1')
2017-09-13 18:01:18, SELECT id, salt
		FROM USER
		WHERE username=?	('user1',)
2017-09-13 18:01:18, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:01:18, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:01:18, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(23, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:01:18, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('username', 'user1')
2017-09-13 18:01:18, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('session_id', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3')
2017-09-13 18:01:18, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('ip', '127.0.0.1')
2017-09-13 18:01:18, SELECT id, salt
...
2017-09-13 18:01:18, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:01:19, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:01:19, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(24, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:01:19, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('username', 'user1')
2017-09-13 18:01:19, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('session_id', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3')
2017-09-13 18:01:19, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('ip', '127.0.0.1')
2017-09-13 18:01:19, SELECT id, salt
		FROM USER
		WHERE username=?	('user1',)
2017-09-13 18:01:19, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:01:19, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:01:19, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(25, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:01:19, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('username', 'user1')
2017-09-13 18:01:19, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('session_id', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3')
2017-09-13 18:01:19, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('ip', '127.0.0.1')
2017-09-13 18:01:19, SELECT id, salt
...
2017-09-13 18:01:19, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:01:20, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:01:20, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(26, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:01:20, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('username', 'user1')
2017-09-13 18:01:20, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('session_id', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3')
2017-09-13 18:01:20, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('ip', '127.0.0.1')
2017-09-13 18:01:20, SELECT id, salt
		FROM USER
		WHERE username=?	('user1',)
2017-09-13 18:01:20, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:01:20, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:01:20, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(27, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:01:20, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('username', 'user1')
2017-09-13 18:01:20, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('session_id', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3')
2017-09-13 18:01:20, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('ip', '127.0.0.1')
2017-09-13 18:01:20, SELECT id, salt
...
2017-09-13 18:01:20, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:01:21, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:01:21, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(28, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:01:21, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('username', 'user1')
2017-09-13 18:01:21, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('session_id', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3')
2017-09-13 18:01:21, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('ip', '127.0.0.1')
2017-09-13 18:01:21, SELECT id, salt
		FROM USER
		WHERE username=?	('user1',)
2017-09-13 18:01:21, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:01:21, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:01:21, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(29, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:01:21, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('username', 'user1')
2017-09-13 18:01:21, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('session_id', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3')
2017-09-13 18:01:21, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('ip', '127.0.0.1')
2017-09-13 18:01:21, SELECT id, salt
...
2017-09-13 18:01:21, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(30, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:01:21, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('username', 'user1')
2017-09-13 18:01:21, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('session_id', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3')
2017-09-13 18:01:21, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('ip', '127.0.0.1')
2017-09-13 18:01:21, SELECT id, salt
...
2017-09-13 18:01:21, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:01:22, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:01:22, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(31, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:01:22, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('username', 'user1')
2017-09-13 18:01:22, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('session_id', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3')
2017-09-13 18:01:22, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('ip', '127.0.0.1')
2017-09-13 18:01:22, SELECT id, salt
		FROM USER
		WHERE username=?	('user1',)
2017-09-13 18:01:22, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:01:22, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:01:22, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(32, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:01:22, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('username', 'user1')
2017-09-13 18:01:22, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('session_id', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3')
2017-09-13 18:01:22, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('ip', '127.0.0.1')
2017-09-13 18:01:22, SELECT id, salt
...
2017-09-13 18:01:22, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(33, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:01:22, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('username', 'user1')
2017-09-13 18:01:22, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('session_id', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3')
2017-09-13 18:01:22, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('ip', '127.0.0.1')
2017-09-13 18:01:22, SELECT id, salt
...
2017-09-13 18:01:22, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:01:23, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:01:23, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(34, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:01:23, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('username', 'user1')
2017-09-13 18:01:23, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('session_id', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3')
2017-09-13 18:01:23, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('ip', '127.0.0.1')
2017-09-13 18:01:23, SELECT id, salt
		FROM USER
		WHERE username=?	('user1',)
2017-09-13 18:01:23, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:01:23, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:01:23, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(35, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:01:23, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('username', 'user1')
2017-09-13 18:01:23, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('session_id', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3')
2017-09-13 18:01:23, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('ip', '127.0.0.1')
2017-09-13 18:01:23, SELECT id, salt
...
2017-09-13 18:01:23, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(36, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:01:23, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('username', 'user1')
2017-09-13 18:01:23, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('session_id', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3')
2017-09-13 18:01:23, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('ip', '127.0.0.1')
2017-09-13 18:01:23, SELECT id, salt
...
2017-09-13 18:01:23, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:01:24, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:01:24, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(37, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:01:24, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('username', 'user1')
2017-09-13 18:01:24, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('session_id', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3')
2017-09-13 18:01:24, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('ip', '127.0.0.1')
2017-09-13 18:01:24, SELECT id, salt
		FROM USER
		WHERE username=?	('user1',)
2017-09-13 18:01:24, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:01:24, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:01:24, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(38, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:01:24, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('username', 'user1')
2017-09-13 18:01:24, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('session_id', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3')
2017-09-13 18:01:24, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('ip', '127.0.0.1')
2017-09-13 18:01:24, SELECT id, salt
...
2017-09-13 18:01:24, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(39, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:01:24, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('username', 'user1')
2017-09-13 18:01:24, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('session_id', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3')
2017-09-13 18:01:24, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('ip', '127.0.0.1')
2017-09-13 18:01:24, SELECT id, salt
...
2017-09-13 18:01:24, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:01:25, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:01:25, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(40, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:01:25, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('username', 'user1')
2017-09-13 18:01:25, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('session_id', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3')
2017-09-13 18:01:25, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('ip', '127.0.0.1')
2017-09-13 18:01:25, SELECT id, salt
		FROM USER
		WHERE username=?	('user1',)
2017-09-13 18:01:25, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:01:25, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:01:25, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(41, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:01:25, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('username', 'user1')
2017-09-13 18:01:25, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('session_id', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3')
2017-09-13 18:01:25, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('ip', '127.0.0.1')
2017-09-13 18:01:25, SELECT id, salt
...
2017-09-13 18:01:25, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:02:18, SELECT 1 FROM sqlite_master WHERE type='table' AND name='USER';
2017-09-13 18:02:18, SELECT 1 FROM sqlite_master WHERE type='table' AND name='LOGIN_REQUESTS';
2017-09-13 18:02:18, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:02:21, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:02:21, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(42, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:02:21, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('username', 'user1')
2017-09-13 18:02:21, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('session_id', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3')
2017-09-13 18:02:21, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND request_time-CURRENT_TIMESTAMP<10	('ip', '127.0.0.1')
2017-09-13 18:02:21, SELECT id, salt
		FROM USER
		WHERE username=?	('user1',)
2017-09-13 18:02:21, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:02:22, SELECT * FROM LOGIN_REQUESTS
2017-09-13 18:04:05, SELECT 1 FROM sqlite_master WHERE type='table' AND name='USER';
2017-09-13 18:04:05, SELECT 1 FROM sqlite_master WHERE type='table' AND name='LOGIN_REQUESTS';
2017-09-13 18:04:05, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:04:12, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:04:12, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(43, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:04:12, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND CURRENT_TIMESTAMP-request_time<10	('username', 'user1')
2017-09-13 18:04:12, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND CURRENT_TIMESTAMP-request_time<10	('session_id', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3')
2017-09-13 18:04:12, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND CURRENT_TIMESTAMP-request_time<10	('ip', '127.0.0.1')
2017-09-13 18:04:12, SELECT id, salt
		FROM USER
		WHERE username=?	('user1',)
2017-09-13 18:04:12, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:04:14, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:04:14, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(44, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:04:14, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND CURRENT_TIMESTAMP-request_time<10	('username', 'user1')
2017-09-13 18:04:14, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND CURRENT_TIMESTAMP-request_time<10	('session_id', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3')
2017-09-13 18:04:14, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND CURRENT_TIMESTAMP-request_time<10	('ip', '127.0.0.1')
2017-09-13 18:04:14, SELECT id, salt
		FROM USER
		WHERE username=?	('user1',)
2017-09-13 18:04:14, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:04:16, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:04:16, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(45, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:04:16, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND CURRENT_TIMESTAMP-request_time<10	('username', 'user1')
2017-09-13 18:04:16, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND CURRENT_TIMESTAMP-request_time<10	('session_id', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3')
2017-09-13 18:04:16, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=? AND CURRENT_TIMESTAMP-request_time<10	('ip', '127.0.0.1')
2017-09-13 18:04:16, SELECT id, salt
		FROM USER
		WHERE username=?	('user1',)
2017-09-13 18:04:16, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:04:26, SELECT 1 FROM sqlite_master WHERE type='table' AND name='USER';
2017-09-13 18:04:26, SELECT 1 FROM sqlite_master WHERE type='table' AND name='LOGIN_REQUESTS';
2017-09-13 18:04:26, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:04:47, SELECT 1 FROM sqlite_master WHERE type='table' AND name='USER';
2017-09-13 18:04:47, SELECT 1 FROM sqlite_master WHERE type='table' AND name='LOGIN_REQUESTS';
2017-09-13 18:04:47, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:04:53, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:04:53, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(46, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:04:53, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=?	('username', 'user1')
2017-09-13 18:04:53, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=?	('session_id', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3')
2017-09-13 18:04:53, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=?	('ip', '127.0.0.1')
2017-09-13 18:04:53, SELECT id, salt
		FROM USER
		WHERE username=?	('user1',)
2017-09-13 18:04:53, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:04:55, SELECT * FROM LOGIN_REQUESTS
2017-09-13 18:05:03, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:05:03, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(47, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:05:03, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=?	('username', 'user1')
2017-09-13 18:05:03, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=?	('session_id', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3')
2017-09-13 18:05:03, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=?	('ip', '127.0.0.1')
2017-09-13 18:05:03, SELECT id, salt
		FROM USER
		WHERE username=?	('user1',)
2017-09-13 18:05:03, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:05:05, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:05:05, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(48, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:05:05, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=?	('username', 'user1')
2017-09-13 18:05:05, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=?	('session_id', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3')
2017-09-13 18:05:05, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=?	('ip', '127.0.0.1')
2017-09-13 18:05:05, SELECT id, salt
		FROM USER
		WHERE username=?	('user1',)
2017-09-13 18:05:05, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:05:17, SELECT 1 FROM sqlite_master WHERE type='table' AND name='USER';
2017-09-13 18:05:17, SELECT 1 FROM sqlite_master WHERE type='table' AND name='LOGIN_REQUESTS';
2017-09-13 18:05:17, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:05:19, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:05:19, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(49, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:05:19, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=?	('username', 'user1')
2017-09-13 18:05:19, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=?	('session_id', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3')
2017-09-13 18:05:19, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=?	('ip', '127.0.0.1')
2017-09-13 18:05:19, SELECT id, salt
		FROM USER
		WHERE username=?	('user1',)
2017-09-13 18:05:19, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:05:21, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:05:21, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(50, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:05:21, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=?	('username', 'user1')
2017-09-13 18:05:21, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=?	('session_id', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3')
2017-09-13 18:05:21, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=?	('ip', '127.0.0.1')
2017-09-13 18:05:21, SELECT id, salt
		FROM USER
		WHERE username=?	('user1',)
2017-09-13 18:05:21, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:05:22, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:05:22, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(51, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:05:22, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=?	('username', 'user1')
2017-09-13 18:05:22, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=?	('session_id', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3')
2017-09-13 18:05:22, SELECT count(*) FROM LOGIN_REQUESTS WHERE ?=?	('ip', '127.0.0.1')
2017-09-13 18:05:22, SELECT id, salt
		FROM USER
		WHERE username=?	('user1',)
2017-09-13 18:05:22, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:05:45, SELECT 1 FROM sqlite_master WHERE type='table' AND name='USER';
2017-09-13 18:05:45, SELECT 1 FROM sqlite_master WHERE type='table' AND name='LOGIN_REQUESTS';
2017-09-13 18:05:45, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:05:52, SELECT 1 FROM sqlite_master WHERE type='table' AND name='USER';
2017-09-13 18:05:52, SELECT 1 FROM sqlite_master WHERE type='table' AND name='LOGIN_REQUESTS';
2017-09-13 18:05:52, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:06:29, SELECT 1 FROM sqlite_master WHERE type='table' AND name='USER';
2017-09-13 18:06:29, SELECT 1 FROM sqlite_master WHERE type='table' AND name='LOGIN_REQUESTS';
2017-09-13 18:06:29, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:07:27, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:07:27, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(52, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:07:27, SELECT COUNT(*) FROM LOGIN_REQUESTS WHERE ?=?	('username', 'user1')
2017-09-13 18:07:27, SELECT COUNT(*) FROM LOGIN_REQUESTS WHERE ?=?	('session_id', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3')
2017-09-13 18:07:27, SELECT COUNT(*) FROM LOGIN_REQUESTS WHERE ?=?	('ip', '127.0.0.1')
2017-09-13 18:07:27, SELECT id, salt
		FROM USER
		WHERE username=?	('user1',)
2017-09-13 18:07:27, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:08:52, SELECT 1 FROM sqlite_master WHERE type='table' AND name='USER';
2017-09-13 18:08:52, SELECT 1 FROM sqlite_master WHERE type='table' AND name='LOGIN_REQUESTS';
2017-09-13 18:08:52, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:09:11, SELECT 1 FROM sqlite_master WHERE type='table' AND name='USER';
2017-09-13 18:09:11, SELECT 1 FROM sqlite_master WHERE type='table' AND name='LOGIN_REQUESTS';
2017-09-13 18:09:11, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:09:14, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:09:14, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(53, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:09:14, SELECT COUNT(*) FROM LOGIN_REQUESTS WHERE username=?	('user1',)
2017-09-13 18:09:49, SELECT 1 FROM sqlite_master WHERE type='table' AND name='USER';
2017-09-13 18:09:49, SELECT 1 FROM sqlite_master WHERE type='table' AND name='LOGIN_REQUESTS';
2017-09-13 18:09:49, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:10:05, SELECT 1 FROM sqlite_master WHERE type='table' AND name='USER';
2017-09-13 18:10:05, SELECT 1 FROM sqlite_master WHERE type='table' AND name='LOGIN_REQUESTS';
2017-09-13 18:10:05, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:10:08, SELECT 1 FROM sqlite_master WHERE type='table' AND name='USER';
2017-09-13 18:10:08, SELECT 1 FROM sqlite_master WHERE type='table' AND name='LOGIN_REQUESTS';
2017-09-13 18:10:08, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:10:11, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:10:11, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(54, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:10:11, SELECT COUNT(*) FROM LOGIN_REQUESTS WHERE username=?	('user1',)
2017-09-13 18:10:26, SELECT 1 FROM sqlite_master WHERE type='table' AND name='USER';
2017-09-13 18:10:26, SELECT 1 FROM sqlite_master WHERE type='table' AND name='LOGIN_REQUESTS';
2017-09-13 18:10:26, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:11:08, SELECT 1 FROM sqlite_master WHERE type='table' AND name='USER';
2017-09-13 18:11:08, SELECT 1 FROM sqlite_master WHERE type='table' AND name='LOGIN_REQUESTS';
2017-09-13 18:11:08, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:11:16, SELECT 1 FROM sqlite_master WHERE type='table' AND name='USER';
2017-09-13 18:11:16, SELECT 1 FROM sqlite_master WHERE type='table' AND name='LOGIN_REQUESTS';
2017-09-13 18:11:16, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:11:18, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:11:18, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(55, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:11:18, SELECT COUNT(*) FROM LOGIN_REQUESTS WHERE username=? AND request_time >= Datetime('now', '-10 seconds')	('user1',)
2017-09-13 18:11:18, SELECT COUNT(*) FROM LOGIN_REQUESTS WHERE ip=? AND request_time >= Datetime('now', '-10 seconds')	('127.0.0.1',)
2017-09-13 18:11:18, SELECT id, salt
		FROM USER
		WHERE username=?	('user1',)
2017-09-13 18:11:18, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:12:15, SELECT 1 FROM sqlite_master WHERE type='table' AND name='USER';
2017-09-13 18:12:15, SELECT 1 FROM sqlite_master WHERE type='table' AND name='LOGIN_REQUESTS';
2017-09-13 18:12:15, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:12:26, SELECT 1 FROM sqlite_master WHERE type='table' AND name='USER';
2017-09-13 18:12:26, SELECT 1 FROM sqlite_master WHERE type='table' AND name='LOGIN_REQUESTS';
2017-09-13 18:12:26, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:12:35, SELECT 1 FROM sqlite_master WHERE type='table' AND name='USER';
2017-09-13 18:12:35, SELECT 1 FROM sqlite_master WHERE type='table' AND name='LOGIN_REQUESTS';
2017-09-13 18:12:35, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:12:39, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:12:39, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(56, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:12:39, SELECT COUNT(*) FROM LOGIN_REQUESTS WHERE username=? AND request_time >= Datetime('now', '-10 seconds')	('user1',)
2017-09-13 18:12:39, SELECT COUNT(*) FROM LOGIN_REQUESTS WHERE ip=? AND request_time >= Datetime('now', '-10 seconds')	('127.0.0.1',)
2017-09-13 18:12:39, SELECT id, salt
		FROM USER
		WHERE username=?	('user1',)
2017-09-13 18:12:39, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:12:43, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:12:43, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(57, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:12:43, SELECT COUNT(*) FROM LOGIN_REQUESTS WHERE username=? AND request_time >= Datetime('now', '-10 seconds')	('user1',)
2017-09-13 18:12:43, SELECT COUNT(*) FROM LOGIN_REQUESTS WHERE ip=? AND request_time >= Datetime('now', '-10 seconds')	('127.0.0.1',)
2017-09-13 18:12:43, SELECT id, salt
		FROM USER
		WHERE username=?	('user1',)
2017-09-13 18:12:43, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:12:45, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:12:45, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(58, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:12:45, SELECT COUNT(*) FROM LOGIN_REQUESTS WHERE username=? AND request_time >= Datetime('now', '-10 seconds')	('user1',)
2017-09-13 18:12:45, SELECT COUNT(*) FROM LOGIN_REQUESTS WHERE ip=? AND request_time >= Datetime('now', '-10 seconds')	('127.0.0.1',)
2017-09-13 18:12:45, SELECT id, salt
		FROM USER
		WHERE username=?	('user1',)
2017-09-13 18:12:45, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:12:56, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:12:56, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(59, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:12:56, SELECT COUNT(*) FROM LOGIN_REQUESTS WHERE username=? AND request_time >= Datetime('now', '-10 seconds')	('user1',)
2017-09-13 18:12:56, SELECT COUNT(*) FROM LOGIN_REQUESTS WHERE ip=? AND request_time >= Datetime('now', '-10 seconds')	('127.0.0.1',)
2017-09-13 18:12:56, SELECT id, salt
		FROM USER
		WHERE username=?	('user1',)
2017-09-13 18:12:56, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:12:59, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:12:59, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(60, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:12:59, SELECT COUNT(*) FROM LOGIN_REQUESTS WHERE username=? AND request_time >= Datetime('now', '-10 seconds')	('user1',)
2017-09-13 18:12:59, SELECT COUNT(*) FROM LOGIN_REQUESTS WHERE ip=? AND request_time >= Datetime('now', '-10 seconds')	('127.0.0.1',)
2017-09-13 18:12:59, SELECT id, salt
		FROM USER
		WHERE username=?	('user1',)
2017-09-13 18:12:59, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:13:00, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:13:00, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(61, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:13:00, SELECT COUNT(*) FROM LOGIN_REQUESTS WHERE username=? AND request_time >= Datetime('now', '-10 seconds')	('user1',)
2017-09-13 18:13:00, SELECT COUNT(*) FROM LOGIN_REQUESTS WHERE ip=? AND request_time >= Datetime('now', '-10 seconds')	('127.0.0.1',)
2017-09-13 18:13:00, SELECT id, salt
		FROM USER
		WHERE username=?	('user1',)
2017-09-13 18:13:00, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:13:02, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:13:02, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(62, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:13:02, SELECT COUNT(*) FROM LOGIN_REQUESTS WHERE username=? AND request_time >= Datetime('now', '-10 seconds')	('user1',)
2017-09-13 18:13:02, SELECT COUNT(*) FROM LOGIN_REQUESTS WHERE ip=? AND request_time >= Datetime('now', '-10 seconds')	('127.0.0.1',)
2017-09-13 18:13:02, SELECT id, salt
		FROM USER
		WHERE username=?	('user1',)
2017-09-13 18:13:02, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:13:03, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:13:03, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(63, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:13:03, SELECT COUNT(*) FROM LOGIN_REQUESTS WHERE username=? AND request_time >= Datetime('now', '-10 seconds')	('user1',)
2017-09-13 18:13:03, SELECT COUNT(*) FROM LOGIN_REQUESTS WHERE ip=? AND request_time >= Datetime('now', '-10 seconds')	('127.0.0.1',)
2017-09-13 18:13:03, SELECT id, salt
		FROM USER
		WHERE username=?	('user1',)
2017-09-13 18:13:03, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:13:03, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:13:03, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(64, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:13:03, SELECT COUNT(*) FROM LOGIN_REQUESTS WHERE username=? AND request_time >= Datetime('now', '-10 seconds')	('user1',)
2017-09-13 18:13:03, SELECT COUNT(*) FROM LOGIN_REQUESTS WHERE ip=? AND request_time >= Datetime('now', '-10 seconds')	('127.0.0.1',)
2017-09-13 18:13:03, SELECT id, salt
		FROM USER
...
2017-09-13 18:13:03, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:13:04, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:13:04, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(65, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:13:04, SELECT COUNT(*) FROM LOGIN_REQUESTS WHERE username=? AND request_time >= Datetime('now', '-10 seconds')	('user1',)
2017-09-13 18:13:04, SELECT COUNT(*) FROM LOGIN_REQUESTS WHERE ip=? AND request_time >= Datetime('now', '-10 seconds')	('127.0.0.1',)
2017-09-13 18:13:04, SELECT id, salt
		FROM USER
		WHERE username=?	('user1',)
2017-09-13 18:13:04, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:13:05, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:13:05, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(66, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:13:05, SELECT COUNT(*) FROM LOGIN_REQUESTS WHERE username=? AND request_time >= Datetime('now', '-10 seconds')	('user1',)
2017-09-13 18:13:05, SELECT COUNT(*) FROM LOGIN_REQUESTS WHERE ip=? AND request_time >= Datetime('now', '-10 seconds')	('127.0.0.1',)
2017-09-13 18:13:05, SELECT id, salt
		FROM USER
		WHERE username=?	('user1',)
2017-09-13 18:13:05, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:13:05, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:13:05, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(67, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:13:05, SELECT COUNT(*) FROM LOGIN_REQUESTS WHERE username=? AND request_time >= Datetime('now', '-10 seconds')	('user1',)
2017-09-13 18:13:05, SELECT COUNT(*) FROM LOGIN_REQUESTS WHERE ip=? AND request_time >= Datetime('now', '-10 seconds')	('127.0.0.1',)
2017-09-13 18:13:05, SELECT id, salt
		FROM USER
...
2017-09-13 18:13:05, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:13:06, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:13:06, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(68, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:13:06, SELECT COUNT(*) FROM LOGIN_REQUESTS WHERE username=? AND request_time >= Datetime('now', '-10 seconds')	('user1',)
2017-09-13 18:13:06, SELECT COUNT(*) FROM LOGIN_REQUESTS WHERE ip=? AND request_time >= Datetime('now', '-10 seconds')	('127.0.0.1',)
2017-09-13 18:13:06, SELECT id, salt
		FROM USER
		WHERE username=?	('user1',)
2017-09-13 18:13:06, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:13:07, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:13:07, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(69, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:13:07, SELECT COUNT(*) FROM LOGIN_REQUESTS WHERE username=? AND request_time >= Datetime('now', '-10 seconds')	('user1',)
2017-09-13 18:13:07, SELECT COUNT(*) FROM LOGIN_REQUESTS WHERE ip=? AND request_time >= Datetime('now', '-10 seconds')	('127.0.0.1',)
2017-09-13 18:13:07, SELECT id, salt
		FROM USER
		WHERE username=?	('user1',)
2017-09-13 18:13:07, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:13:07, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:13:07, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(70, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:13:07, SELECT COUNT(*) FROM LOGIN_REQUESTS WHERE username=? AND request_time >= Datetime('now', '-10 seconds')	('user1',)
2017-09-13 18:13:07, SELECT COUNT(*) FROM LOGIN_REQUESTS WHERE ip=? AND request_time >= Datetime('now', '-10 seconds')	('127.0.0.1',)
2017-09-13 18:13:09, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:13:09, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(71, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:13:09, SELECT COUNT(*) FROM LOGIN_REQUESTS WHERE username=? AND request_time >= Datetime('now', '-10 seconds')	('user1',)
2017-09-13 18:13:09, SELECT COUNT(*) FROM LOGIN_REQUESTS WHERE ip=? AND request_time >= Datetime('now', '-10 seconds')	('127.0.0.1',)
2017-09-13 18:13:10, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:13:10, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(72, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:13:10, SELECT COUNT(*) FROM LOGIN_REQUESTS WHERE username=? AND request_time >= Datetime('now', '-10 seconds')	('user1',)
2017-09-13 18:13:10, SELECT COUNT(*) FROM LOGIN_REQUESTS WHERE ip=? AND request_time >= Datetime('now', '-10 seconds')	('127.0.0.1',)
2017-09-13 18:14:40, SELECT 1 FROM sqlite_master WHERE type='table' AND name='USER';
2017-09-13 18:14:40, SELECT 1 FROM sqlite_master WHERE type='table' AND name='LOGIN_REQUESTS';
2017-09-13 18:14:40, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:15:12, SELECT 1 FROM sqlite_master WHERE type='table' AND name='USER';
2017-09-13 18:15:12, SELECT 1 FROM sqlite_master WHERE type='table' AND name='LOGIN_REQUESTS';
2017-09-13 18:15:12, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:15:35, SELECT 1 FROM sqlite_master WHERE type='table' AND name='USER';
2017-09-13 18:15:35, SELECT 1 FROM sqlite_master WHERE type='table' AND name='LOGIN_REQUESTS';
2017-09-13 18:15:35, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:15:41, SELECT 1 FROM sqlite_master WHERE type='table' AND name='USER';
2017-09-13 18:15:41, SELECT 1 FROM sqlite_master WHERE type='table' AND name='LOGIN_REQUESTS';
2017-09-13 18:15:41, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:16:24, SELECT MAX(id) FROM LOGIN_REQUESTS
2017-09-13 18:16:24, 
		INSERT INTO LOGIN_REQUESTS (id,username,session_id,ip)
		VALUES
		(?,?,?,?)	(73, 'user1', '605828d71790dd86014595c373243f6e71963954d3330b74a77147bdeed3', '127.0.0.1')
2017-09-13 18:16:24, SELECT COUNT(*) FROM LOGIN_REQUESTS WHERE username=? AND request_time >= Datetime('now', '-10 seconds')	('user1',)
2017-09-13 18:16:24, SELECT COUNT(*) FROM LOGIN_REQUESTS WHERE ip=? AND request_time >= Datetime('now', '-10 seconds')	('127.0.0.1',)
2017-09-13 18:16:24, SELECT id, salt
		FROM USER
		WHERE username=?	('user1',)
2017-09-13 18:16:24, SELECT 1
		FROM USER
		WHERE username=? and password = ?	('user1', '533f960417337dfb7e60eb16add9dad5ae9c715150ac8744ea228751f8126600')
2017-09-13 18:16:30, SELECT 1 FROM sqlite_master WHERE type='table' AND name='USER';
2017-09-13 18:16:30, SELECT 1 FROM sqlite_master WHERE type='table' AND name='LOGIN_REQUESTS';
2017-09-13 18:16:30, SELECT MAX(id) FROM LOGIN_REQUESTS
